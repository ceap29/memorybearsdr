        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <h2 className="text-4xl font-bold text-navy-900">{t('home.whatAreMemoryBears.title')}</h2>
              <p className="text-lg text-navy-800">
                {t('home.whatAreMemoryBears.paragraph1')}
              </p>
              <p className="text-lg text-navy-800">
                {t('home.whatAreMemoryBears.paragraph2')}
              </p>
              <p className="text-lg text-navy-800">
                {t('home.whatAreMemoryBears.paragraph3')}
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8 px-4">
              <h2 className="text-5xl font-bold text-navy-900">{t('home.aboutMe.title')}</h2>
