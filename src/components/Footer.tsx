        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-white hover:text-blue-200 transition-colors" aria-label="Pinterest">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.02 0c-6.63 0-12 5.37-12 12 0 5.07 3.14 9.4 7.57 11.14-.1-.94-.2-2.37.04-3.4.2-.86 1.3-5.54 1.3-5.54s-.33-.67-.33-1.67c0-1.57.9-2.74 2.04-2.74.95 0 1.4.72 1.4 1.57 0 .96-.6 2.4-.93 3.74-.26 1.12.57 2.04 1.68 2.04 2.02 0 3.6-2.13 3.6-5.2 0-2.73-1.95-4.62-4.75-4.62-3.23 0-5.13 2.42-5.13 4.93 0 .97.36 2.02.84 2.6.1.11.1.22.08.32-.1.37-.32 1.17-.35 1.33-.05.22-.18.27-.42.16-1.55-.73-2.52-3.03-2.52-4.85 0-3.6 2.62-6.9 7.54-6.9 3.97 0 7.03 2.83 7.03 6.6 0 3.94-2.48 7.1-5.9 7.1-1.14 0-2.22-.6-2.6-1.3 0 0-.57 2.17-.71 2.7-.26.98-.97 2.2-1.43 2.95 1.07.32 2.2.5 3.37.5 6.63 0 12-5.37 12-12s-5.37-12-12-12z"/>
                </svg>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-blue-200">123 Memory Lane, Heartville, TX 12345</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 mt-0.5 mr-2 text-blue-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-blue-200">info@memorybears.com</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 mt-0.5 mr-2 text-blue-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
